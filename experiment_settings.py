...
def get_settings(experiment_name):
    experiments = {
        ...
        "exp3": {
            ...
            "dense_units": 32,
            "loss": "DenseDualWeightMSE",
            "loss_params": (0.2, 50.0),  # gamma power, offset
            "kluge_value_for_zero": 0.0,  # -0.2,
            "kluge_value_for_one": 0.0,  # -0.2,
            "aug_randomflip": True,
            "input_noise": 10,  # in units of rgb values
        ...
        "exp5": {
            ...
            "dense_units": 32,
            "loss": "DenseDualWeightMSE",
            "loss_params": (.5, 50, 25),  # gamma power, offset
            "sample_weights_alpha": 15.0,
            "kluge_value_for_zero": 0.0,  # -0.2,
            "kluge_value_for_one": 0.0,  # -0.2,
            "aug_randomflip": True,
            "input_noise": 20,  # in units of rgb values
            "subsample": True,
            "learning_rate": 0.001,
            "dropout": 0.10,
            "patience": 3,
        ...
        "exp6": {
            ...
            "dense_units": 32,
            "loss": "DenseDualWeightMSE",
            "loss_params": (0.2, 50.0, 0),  # gamma power, offset
            "kluge_value_for_zero": 0.0,  # -0.2,
            "kluge_value_for_one": 0.0,  # -0.2,
            "aug_randomflip": True,
            "input_noise": 10,  # in units of rgb values
        ...
        "exp7": {
            ...
            "dense_units": 32,
            "loss": "DenseDualWeightMSE",
            "loss_params": (0.5, 50.0, 30.),  # gamma power, offset
            "aug_randomflip": True,
            "input_noise": 5,  # in units of rgb values
            "sample_weights_alpha": 15.0,
            "subsample": True,
            "learning_rate": 0.001,
            "dropout": 0.10,
