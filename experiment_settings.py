...
def get_settings(experiment_name):
    experiments = {
        ...
        "exp1": {
            ...
            "tilename": "06S_107E",
            # "latlon_bounds": (-6.04, -6.92, 106.05, 106.93),  # (lat0, lat1, lon0, lon1)
            "latlon_bounds": (-6.04, -6.92, 107.6, 107.93),  # (lat0, lat1, lon0, lon1)
            "channels": (1, 2, 3, 4, 5, 6),  # indexing starts at 1
            "nbatches": (300, 50),  # (training_batches, validation_batches)
            "scene_width": 100,  # in units of landsat pixels
            "rng_seed": 33,
